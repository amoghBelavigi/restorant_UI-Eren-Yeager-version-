  ...
  <div className='app__footer section__padding'>
    ...
    <div className='app__footer-links'>
      <div className='app__footer-links_contact'>
        ...
        <p className='p__opensans'>Beside Wall Maria, Shiganshina District,  Paradis Island</p>
        <p className='p__opensans'>+05-09876-54321</p>
      </div>
    ...
    <div className='footer__copyright'>
      <p className='p__opensans'>2022 WINE N' DINE</p>
    </div>
